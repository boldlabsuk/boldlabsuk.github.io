...
The early homepage proof that BOLD spans Oxford, UCL, and Imperial, presented as supporting credibility rather than the main identity.
_Avoid_: Consortium-led headline, three university labs as the core proposition
...
**Primary Person Link**:
The default destination for clicking a person's photo or name in a Person Listing. It prefers the person's website, then Google Scholar, then an available social link; if no links exist, the listing is not clickable.
