...
export function HomePage({
  ...
  return (
    <>
      <HomeHero onLogoVisibilityChange={onHeroLogoVisibilityChange} />
      <VisionSection />
...
function HomeHero({
  ...
  const heroLogoRef = useHeroLogoVisibility(onLogoVisibilityChange)

  return (
    <section className="home-hero" aria-labelledby="home-hero-title">
      <HomeHeroBrand heroLogoRef={heroLogoRef} />
...
function HomeHeroBrand({
  ...
  heroLogoRef: Ref<HTMLImageElement>
}) {
  return (
...
function ResearchPillarsSection() {
  return (
    <section
          ...
          {homepageContent.researchPillars.map((pillar, index) => (
            <li className="editorial-list-item pillar-item" key={pillar.name}>
              <article>
                ...
                <p className="pillar-item-description">{pillar.description}</p>
              </article>
            </li>
          ))}
        </ol>
...
function TeamSection() {
  return (
    <section className="home-section team-section" aria-labelledby="team-title">
...
function useHeroLogoVisibility(
  onLogoVisibilityChange?: (isVisible: boolean) => void,
) {
  ...
  useEffect(() => {
    ...
    if (!heroLogo || !onLogoVisibilityChange) {
      return
    }
    ...
    const updateLogoVisibilityFromRect = () => {
      ...
      onLogoVisibilityChange(isHeroLogoVisible(heroLogo))
    }
...
function isHeroLogoVisible(heroLogo: HTMLImageElement) {
  ...
  const visibleTextBottom =
    rect.top + rect.height * boldLogoTextVisualBottomRatio

  return (
    visibleTextBottom > headerBottom + navbarLogoRevealOffsetPx &&
