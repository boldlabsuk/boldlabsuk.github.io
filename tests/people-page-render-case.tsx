...
const xiListingIndex = peoplePage.indexOf('Xi Xiong')
...
assert.ok(xiListingIndex > associateFacultySectionIndex)
assert.ok(xiListingIndex < associateMembersSectionIndex)
